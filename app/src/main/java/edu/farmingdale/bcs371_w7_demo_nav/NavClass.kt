...
fun SecondScreen(navController: NavController) {
    ...
    Column ( modifier = Modifier.padding(horizontal = 20.dp),
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally){
        Slider(value = sliderValue, onValueChange = { sliderValue=it }, Modifier.fillMaxWidth(), enabled = checkBoxValue)
        ...
        Checkbox(checked = checkBoxValue, onCheckedChange = { checkBoxValue = it }, modifier = Modifier.padding(10.dp))
